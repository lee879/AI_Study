...
class MainWindow(QTabWidget):
    ...
    def __init__(self):
        ...
        self.setWindowIcon(QIcon("images/UI/ai.jpg"))
        # 图片读取进程
        ...
        self.txt_path = r"D:\yolov5_GAM_Trasformer_ASFF\6903756704_gui\test_out/"
        self.model = self.model_load(weights=r"D:\yolov5_GAM_Trasformer_ASFF\6903756704_gui\runs\train\exp17\weights\best.pt",
    ...
    ***界面初始化***
    ...
    def initUI(self):
        ...
        up_img_button.setStyleSheet("QPushButton{color:white}"
                                    "QPushButton:hover{background-color: rgb(119,68,51);}"
                                    "QPushButton{background-color:rgb(119,85,68)}"
       ...
       # self.addTab(about_widget, '联系我')
        self.setTabIcon(0, QIcon('images/UI/ai.jpg'))
        self.setTabIcon(1, QIcon('images/UI/ai.jpg'))
        self.setTabIcon(2, QIcon('images/UI/ai.jpg'))
    ...
    ***检测图片***
                    ...
                    if len(det):
                        ...
                        for *xyxy, conf, cls in reversed(det):
                            if save_txt:  # Write to file
                                ...
                                with open(self.txt_path + '0.txt', 'a') as f:
    ...
    def detect_vid(self):
        ...
        for path, im, im0s, vid_cap, s in dataset:
            t1 = time_sync()
            im = torch.from_numpy(im).to(device)
            im = im.half() if half else im.float16()  # uint8 to fp16/32
            #im= torch.Tensor.to(float)
            im /= 255  # 0 - 255 to 0.0 - 1.0
            if len(im.shape) == 3:
                im = im[None]  # expand for batch dim
            t2 = time_sync()
